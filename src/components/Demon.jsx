  ...
  return (
    ...
    <motion.div
            ...
            transition={{ duration: 0.4 }}>
             <h2 className='text-white font-semibold' style={{marginTop:'90px', marginLeft:'150px'}}> Demon Slayer </h2>
            </motion.div>
		...
		<div className="col-7 border-start">
		 ...
		 <div  className='d-flex gap-4' style={{"marginLeft":'60px'}}>
          ...
          >
          <img className='card shadow' style={{'height':'300px', 'width':'230px'}} src="/img/Demon-Slayer.jpg" alt="" />
          ...
          <img className='card shadow mt-4' style={{'height':'240px', 'width':'150px'}} src="/img/jujutsu.jpg" alt="" />
